...
public:
	...
	void BresenhamwithTable(int x1, int y1, int x2, int y2, std::vector<sCelda>& table, Color color);

	void drawTriangleInterpolated(int x0, int y0, int x1, int y1, int x2, int y2, Color c0, Color c1, Color c2);
	void Zbuffer(const Vector3& p0, const Vector3& p1, const Vector3& p2, FloatImage *zbuffer);
	void texturing(const Vector3& p0, const Vector3& p1, const Vector3& p2, const Vector2& uv1, const Vector2& uv2, const Vector2& uv3, Image* texture, FloatImage* zbuffer);
